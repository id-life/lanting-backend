...
-- AddForeignKey
ALTER TABLE `email_whitelists` ADD CONSTRAINT `email_whitelists_user_id_fkey` FOREIGN KEY (`user_id`) REFERENCES `User`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `pending_archive_origs` ADD CONSTRAINT `pending_archive_origs_user_id_fkey` FOREIGN KEY (`user_id`) REFERENCES `User`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
