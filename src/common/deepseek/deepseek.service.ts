  ...
  "highlights": [
    {
      ...
      "reason": "具体说明这个内容的价值：能解决什么问题、提供什么新认知、有什么实用性或启发性。避免空洞的赞美词汇（30-150字）"
    }
  ],
  "keywords": {
    "extracted": ["关键词1", "关键词2", ...]
...
注意：highlights数组中应该包含文章最精华、最能代表文章核心价值的内容，按重要性排序。对于"精彩金句"类型，content应包含原文的精确引用加上必要的背景说明；对于其他类型，content字段必须是多句话的详细描述，包含背景、核心内容、具体细节，让读者不看原文也能完全理解。reason字段要说明实际价值和应用场景，不要写"很有启发性"、"值得思考"等空话套话。
`
